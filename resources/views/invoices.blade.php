		...
		<article>
			...
			<table class="meta">
				<tr>
					...
					<td><span contenteditable>{{ rand() }}</span></td>
				</tr>
				<tr>
                    <th><span contenteditable>Date</span></th>
                    <td><span contenteditable>{{ now()->toFormattedDateString() }}</span></td>
                </tr>
                <tr>
                    <th><span contenteditable>Amount</span></th>
                    <td><span id="prefix" contenteditable>${{$basePrice}}</span></td>
                </tr>
			</table>
			<table class="inventory">
				...
				<tbody>
					<tr>
						...
						<td><span data-prefix>${{ $basePrice }}</span></td>
						<td><span data-prefix>${{ $basePrice - $testdiscountedAmount}}</span></td>
						<td><span data-prefix>${{ $basePrice }}</span></td>
					</tr>
				</tbody>
			</table>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix>${{$testdiscountedAmount}}</span></td>
				</tr>
